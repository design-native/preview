...
let lang33 = ["To tokenize centralized carbon emission data, the Notary Oracle verifies the data and certifies it through a multi-signature process between the sender and receiver, ensuring the reliability of the external data.", "To tokenize centralized carbon emission data, the Notary Oracle verifies the data and certifies it through a multi-signature process between the sender and receiver, ensuring the reliability of the external data."];
let lang34 = ["", ""];
...
let lang37 = ["The Net Zero Consensus is a mechanism designed to transparently manage and coordinate carbon emissions, reductions, and carbon credits. <Br/>It leverages blockchain technology to reliably verify and record carbon credits (emission rights and offset credits), reduction activities, and the burning process.", "The Net Zero Consensus is a mechanism designed to transparently manage and coordinate carbon emissions, reductions, and carbon credits. <Br/>It leverages blockchain technology to reliably verify and record carbon credits (emission rights and offset credits), reduction activities, and the burning process."];
...
let lang42 = ["<B>We design systematic reduction strategies and strengthen sustainability through performance-based carbon credit issuance.</b>", "<b>우리는 체계적인 감축 전략을 설계하고 성과 기반 탄소 크레딧 발행을 통해 지속 가능성을 강화합니다.</b>"];
...
let lang50 = ["<b>ExoMad Green's Sustainable<br/>Biochar Project in Bolivia<b/>", "<b>ExoMad Green의 지속 가능한<br/>바이오차 프로젝트 (볼리비아)<b/>"];
...
let lang52 = ["<b>A Unique and Influential<br/>REDD+ Project Preserving<br/>the Tropical Rainforest<b/>", "<B>독특하고 영향력 있는<br/>REDD+ 프로젝트로 열대 우림 보존<b/>"];
